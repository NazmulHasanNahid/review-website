...
const About = () => {
  return (
    <div style={{ background: "rgb(245, 245, 245)" }} className="py-5">
      <Container>
        <h2 className="text-center mb-4 text-primary fw-bold mb-5 mt-5" >WELCOME TO CODING CLUB INSTITUTE</h2>
        <Row>
          <Col className="pe-3">
            ...
            <p>
              ...
              <h5 className="text-primary">our reason</h5>        
            <p>
        ...
        <Row className="mt-4">
          <Col>
            <h5 className="text-primary">Sign up for our monthly newsletter</h5>
